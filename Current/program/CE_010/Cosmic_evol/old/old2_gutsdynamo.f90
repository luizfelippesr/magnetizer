...
!
  implicit none
!
  integer, parameter :: nxphys= 61!61!91  !Resolution in r (excluding ghost zones) (for convenience should be N*r_disk_kpc+1)
...
!
  ...
  double precision, dimension(nx) :: Bsqtot, DivVishniac, Dyn_gen, brms, Bp_floor
...
!
      if (Floor) then
        ...
        brms= fmag*Beq
        Bp_floor= brms/dsqrt(Ncells)*lmax/delta_r*lambda
        do i=nxghost+1,nx-nxghost
