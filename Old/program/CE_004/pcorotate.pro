...
rnew=  dblarr(nx)
rnew  [*,0]= r
rnew  [*]=   rnew[*,0]	;to avoid leaving out a wedge
;
Brnew=   dblarr(nx)
Bpnew=   dblarr(nx)
Bznew=   dblarr(nx)
...
for nt=ntmin,ntmax do begin
  ...
  deltanew=delta[nt,*]
  pBnew   =   pB[nt,*]
  phinewcorotate=  dblarr(nx)
  Bnewcorotate=    dblarr(nx)
  Brnewcorotate=   dblarr(nx)
  Bpnewcorotate=   dblarr(nx)
  Bznewcorotate=   dblarr(nx)
  deltanewcorotate=dblarr(nx)
  pBnewcorotate=   dblarr(nx)
  Bnew    [*]=    B[nt,*]
  pBnew   [*]=   pB[nt,*]
  ;
