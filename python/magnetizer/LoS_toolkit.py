...
def run_LoS(runtype, parameters_file, gal_id, iz, theta, wavelength=20e-2, ignore_small_scale=False, 
            zmax=None, ymax=None, imgdir='img', cwd=None, verbose=False):
...
class Stokes_data(object):
    def __init__(self, parameters_file, gal_id, iz, theta, wavelength=20e-2, 
                 ignore_small_scale=False, zmax=None, dust=False,
