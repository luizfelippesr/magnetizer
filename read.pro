...
;read initial values
readf,11,r,h_init,om_init,Uz_init,Ur_init,l_init,v_init,etat_init,tau_init,alp_k_init,n_init,Beq_init,Br_init,Bp_init,Bzmod_init
close,11
if (nvar eq 2 or nvar eq 4) then begin	;no dynamical quenching
  ...
  readf,13,ts_t,ts_Br,ts_Bp,         ts_Bzmod,ts_h,ts_om,ts_G,ts_l,ts_v,ts_etat,ts_tau,ts_alp_k,ts_Uz,ts_Ur,ts_n,ts_Beq
  close,13
  alp_m=0.*alp_k
endif else begin
  ;read final timestep values
